...
def run_test_count_negatives():
    ...
    # -------------------------------------------------------------------------
    # Done (continued):  Add your 2 ADDITIONAL tests here:
    # -------------------------------------------------------------------------

    # Test 6:
    expected = 3
    actual = count_negatives([-300, -2, 4.5, -0.01, 230])
    print()
    ...
    # Test 7:
    expected = 4
    actual = count_negatives([-200, 3, -4, 5, -123, -60000])
    print()
...
def run_test_count_short_ones():
    ...
    # -------------------------------------------------------------------------
    # Done4 (continued):  Add your 2 ADDITIONAL test(s) here:
    # -------------------------------------------------------------------------

    # Test 8:
    expected = 4
    seq = [[1, 2], [1, 3, 4, 5], [9, 8], [], [2, 10]]
    actual = count_short_ones(seq)
    print()
